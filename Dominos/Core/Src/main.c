...
osThreadId Jeu1Handle;
osThreadId Jeu2Handle;
osThreadId Jeu3Handle;
osThreadId Jeu4Handle;
osThreadId AdvHandle;
osMutexId Mutex1Handle;
/* USER CODE BEGIN PV */
uint8_t i1, j1, i2, j2, i3, j3, i4, j4, s1, s2, s3, s4,advx,advy,advn,advm;
uint8_t rxbuffer[10];
uint8_t txbuffer[10];
...
/* USER CODE BEGIN Header_fcn_adv */
/**
* @brief Function implementing the Adv thread.
* @param argument: Not used
* @retval None
*/
...
void fcn_adv(void const * argument)
{
  ...
  /* USER CODE END fcn_adv */
}

/* USER CODE BEGIN Header_fcn_jeu1 */
/**
 * @brief Function implementing the Jeu1 thread.
 * @param argument: Not used
 * @retval None
 */
...
void fcn_jeu1(void const * argument)
{
  ...
  /* USER CODE END fcn_jeu1 */
}

/* USER CODE BEGIN Header_fcn_jeu2 */
/**
 * @brief Function implementing the Jeu2 thread.
 * @param argument: Not used
 * @retval None
 */
...
void fcn_jeu2(void const * argument)
{
  ...
  /* USER CODE END fcn_jeu2 */
}

/* USER CODE BEGIN Header_fcn_jeu3 */
/**
 * @brief Function implementing the Jeu3 thread.
 * @param argument: Not used
 * @retval None
 */
...
void fcn_jeu3(void const * argument)
{
  ...
  /* USER CODE END fcn_jeu3 */
}

/* USER CODE BEGIN Header_fcn_jeu4 */
/**
 * @brief Function implementing the Jeu4 thread.
 * @param argument: Not used
 * @retval None
 */
